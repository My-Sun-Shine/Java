...
public class User {
    ...
    private String lockState;//锁定状态 1启用 0锁定
    private String deptno;//部门编号
    private String allowIps;//允许id
    ...
    public User(String id, String loginAct, String name, String loginPwd, String email, String expireTime
            , String lockState, String deptno, String allowIps, String createTime, String createBy
            , String editTime, String editBy) {
        this.id = id;
