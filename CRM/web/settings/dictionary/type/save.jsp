...
<body>
    ...
    <form id="dicTypeForm" class="form-horizontal" role="form" method="post"
          action="settings/dictionary/type/saveDicType.do">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10" style="width: 300px;">
                <input type="text" class="form-control" id="name" style="width: 200%;" name="name">
            </div>
        </div>
